...
contract Domains is ERC721URIStorage {
    ...
    //This will store all our values in strings
    mapping(string => string) public records;

  constructor(string memory _tld) payable ERC721("Pal name service", "PNS") {
      tld = _tld;
    console.log("%s name service deployed", _tld);
  }

  //pure functions are helper functions. doesnt change or modify the contract state
      ...
      bytes(
        string(
          abi.encodePacked(
            '{"name": "',
            _name,
            '", "description": "A domain on the Pal name service", "image": "data:image/svg+xml;base64,',
  ...
  // This function will give us the domain owner's address
